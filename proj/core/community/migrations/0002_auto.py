...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field followers on 'Community'
        m2m_table_name = db.shorten_name(u'community_community_followers')
        ...
        db.create_unique(m2m_table_name, ['community_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field followers on 'Community'
        db.delete_table(db.shorten_name(u'community_community_followers'))
