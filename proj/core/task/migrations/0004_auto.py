...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field repliers on 'Task'
        m2m_table_name = db.shorten_name(u'task_task_repliers')
    ...
    def backwards(self, orm):
        # Removing M2M table for field repliers on 'Task'
        db.delete_table(db.shorten_name(u'task_task_repliers'))
