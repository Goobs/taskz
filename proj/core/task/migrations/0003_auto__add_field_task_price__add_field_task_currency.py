...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.price'
        db.add_column(u'task_task', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Task.currency'
        db.add_column(u'task_task', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.price'
        db.delete_column(u'task_task', 'price')

        # Deleting field 'Task.currency'
        db.delete_column(u'task_task', 'currency_id')
