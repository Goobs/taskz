...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'group_group_users')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'group_group_users'))
    ...
    models = {
        ...
        u'group.group': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'communities'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        }
    }
