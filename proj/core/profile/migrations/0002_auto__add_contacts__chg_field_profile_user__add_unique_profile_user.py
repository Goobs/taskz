...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profile_contacts', (
        ...
        db.send_create_signal(u'profile', ['Contacts'])


        # Changing field 'Profile.user'
        db.alter_column(u'profile_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'profile_contacts')


        # Changing field 'Profile.user'
        db.alter_column(u'profile_profile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
