...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_user_friends')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_user', models.ForeignKey(orm[u'core.user'], null=False)),
            ('to_user', models.ForeignKey(orm[u'core.user'], null=False))
        ))
        ...
        db.create_table(u'core_contact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['core.User'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'core_user_friends'))
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contacts'", 'to': u"orm['core.User']"}),
