...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_user', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'User.avatar'
        db.alter_column(u'core_user', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'phone'", 'max_length': '15'}),
